...
<head>
  ...
  <body class="login-body">
    ...
    <div class="container">
      ...
      <form class="form-signin" action="<?php echo $base_url; ?>/controller.php" method="POST">
        <?php
            if(isset($notification)){
                echo $notification;
            }
        ?>
                <h2 class="form-signin-heading" style="font-size: 25px;"><br><br> <strong>REGISTER</strong></h2>
        <div class="login-wrap">
            ...
            <div class="form-group">
                <input type="submit" name="signup" class="form-control btn-primary">
            </div>
