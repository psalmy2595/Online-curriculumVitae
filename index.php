...
<head>
  ...
  <body class="login-body">
    ...
    <div class="container">
      ...
      <form class="form-signin" action="<?php echo $base_url; ?>/controller.php" method="POST" name="form-login" >
        <h2 class="form-signin-heading" style="font-size: 25px;"><br><br> <strong>LOGIN</strong></h2>
        ...
        <div class="login-wrap">
            ...
            <!--  -->
            <input type="submit" name="login" class="btn-primary form-control">

            <div class="registration">
                Don't have an account yet?
                <a class="" href="<?php echo $base_url; ?>/signup.php">
                    Create an account
                </a>
            </div>
